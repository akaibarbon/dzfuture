...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Future DZ" },
      { name: "twitter:title", content: "Future DZ" },
      { property: "og:description", content: "Future DZ — منصة الطلاب الجزائريين" },
      { name: "twitter:description", content: "Future DZ — منصة الطلاب الجزائريين" },
