...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/teach-technics/tool/:id" element={<ProtectedRoute><TeachTechnicsToolPage /></ProtectedRoute>} />
      <Route path="/teach-technics/admin" element={<ProtectedRoute><AdminTeachTechnicsPage /></ProtectedRoute>} />
